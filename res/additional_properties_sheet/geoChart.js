sap.designstudio.sdk.PropertyPage.subclass("com.sample.utilities.GeoChartPage",  function() {
	var that = this;
	this.rendered = false;
	...
	this.updateProps = function(){
		...
		this._comboGroupBy.addItem(new sap.ui.core.ListItem({
			key : "Query Navigations",
			text: "Query Navigations",
			additionalText : "Query Navigations" 
		}));
	...
	this.init = function(){
		...
		this._content.addContent(new sap.ui.commons.TextView({text : "Select Measure"}));
		this._content.addContent(this._comboGroupBy);
		this._content.addContent(new sap.ui.commons.TextView({text : "Geographic Dimension"}));
